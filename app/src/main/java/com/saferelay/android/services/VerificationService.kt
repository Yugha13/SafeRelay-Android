...
object VerificationService {
    private const val CONTEXT = "saferelay-verify-v1"
    private const val RESPONSE_CONTEXT = "saferelay-verify-resp-v1"
    ...
    data class VerificationQR(
        ...
        companion object {
            fun fromUrlString(urlString: String): VerificationQR? {
                ...
                if (uri.scheme != "saferelay" || uri.host != "verify") return null
