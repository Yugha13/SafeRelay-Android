package com.saferelay.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.saferelay.android.model.SafeRelayFilePacket
    ): String {
    ...
    /**
     * Classify SafeRelayMessageType from MIME string used in file messages.
     */
    fun messageTypeForMime(mime: String): com.saferelay.android.model.SafeRelayMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.saferelay.android.model.SafeRelayMessageType.Image
            lower.startsWith("audio/") -> com.saferelay.android.model.SafeRelayMessageType.Audio
            else -> com.saferelay.android.model.SafeRelayMessageType.File
        }
    }
