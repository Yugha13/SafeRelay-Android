package com.saferelay.android.service
...
class MeshForegroundService : Service() {
    ...
    companion object {
        private const val CHANNEL_ID = "saferelay_mesh_service"
        private const val NOTIFICATION_ID = 10001

        const val ACTION_START = "com.saferelay.android.service.START"
        const val ACTION_STOP = "com.saferelay.android.service.STOP"
        const val ACTION_QUIT = "com.saferelay.android.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "com.saferelay.android.service.UPDATE_NOTIFICATION"
        const val ACTION_NOTIFICATION_PERMISSION_GRANTED = "com.saferelay.android.action.NOTIFICATION_PERMISSION_GRANTED"
    ...
    private fun buildNotification(activePeers: Int): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .addAction(
                ...
                getString(R.string.notification_action_quit_saferelay),
                quitPendingIntent
            )
            .build()
    }
