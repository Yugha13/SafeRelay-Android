package com.saferelay.android.noise

import android.content.Context
import android.util.Log
import com.saferelay.android.identity.SecureIdentityStateManager
import com.saferelay.android.mesh.PeerFingerprintManager
import com.saferelay.android.noise.southernstorm.protocol.Noise
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.saferelay.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.saferelay.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.saferelay.android.noise.southernstorm.protocol.Noise.createDH("25519")
    ...
    /**
     * Sign a SafeRelayPacket using our Ed25519 signing key
     */
    fun signPacket(packet: com.saferelay.android.protocol.SafeRelayPacket): com.saferelay.android.protocol.SafeRelayPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.saferelay.android.protocol.SafeRelayPacket, publicKey: ByteArray): Boolean {
