...
import com.saferelay.android.nostr.GeohashMessageHandler
import com.saferelay.android.nostr.GeohashRepository
import com.saferelay.android.nostr.NostrDirectMessageHandler
import com.saferelay.android.nostr.NostrIdentityBridge
import com.saferelay.android.nostr.NostrProtocol
import com.saferelay.android.nostr.NostrRelayManager
import com.saferelay.android.nostr.NostrSubscriptionManager
import com.saferelay.android.nostr.PoWPreferenceManager
import com.saferelay.android.nostr.GeohashAliasRegistry
import com.saferelay.android.nostr.GeohashConversationRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.saferelay.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.saferelay.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.saferelay.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.saferelay.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.saferelay.android.model.SafeRelayMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.saferelay.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.saferelay.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.saferelay.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.saferelay.android.model.SafeRelayMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.saferelay.android.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.saferelay.android.geohash.ChannelID.Mesh -> {
            ...
            is com.saferelay.android.geohash.ChannelID.Location -> {
