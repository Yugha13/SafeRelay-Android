...
import com.saferelay.android.features.file.FileUtils
 ...
 */
private fun tryOpenFile(context: Context, packet: SafeRelayFilePacket) {
    try {
        // First try to save to temp file and open
        val tempFile = File.createTempFile("saferelay_", ".${packet.fileName.substringAfterLast(".")}", context.cacheDir)
