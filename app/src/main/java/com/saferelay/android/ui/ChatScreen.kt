...
import com.saferelay.android.ui.media.FullScreenImageViewer
...
fun ChatScreen(viewModel: ChatViewModel, embedded: Boolean = false) {
    ...
    var selectedMessageForSheet by remember { mutableStateOf<SafeRelayMessage?>(null) }
    ...
    val displayMessages = when {
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.saferelay.android.geohash.ChannelID.Location) {
    ...
    val showMediaButtons = when {
        ...
        else -> selectedLocationChannel !is com.saferelay.android.geohash.ChannelID.Location
    }
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.saferelay.android.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.saferelay.android.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
            ...
            Surface(
                ...
                IconButton(onClick = { forceScrollToBottom = !forceScrollToBottom }) {
                    Icon(
                        ...
                        contentDescription = stringResource(com.saferelay.android.R.string.cd_scroll_to_bottom),
...
private fun ChatDialogs(
    ...
    selectedMessageForSheet: SafeRelayMessage?,
    viewModel: ChatViewModel,
    ...
    if (showDebugSheet) {
        com.saferelay.android.ui.debug.DebugSettingsSheet(
