...
/**
 * SafeRelay-over-Nostr Adapter
 * Direct port from iOS implementation for 100% compatibility
 */
object NostrEmbeddedSafeRelay {
    
    private const val TAG = "NostrEmbeddedSafeRelay"
    
    /**
     * Build a `saferelay1:` base64url-encoded SafeRelay packet carrying a private message for Nostr DMs.
     */
    ...
    /**
     * Build a `saferelay1:` base64url-encoded SafeRelay packet carrying a delivery/read ack for Nostr DMs.
     */
