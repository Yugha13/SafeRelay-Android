<p align="center">
    <img src="https://github.com/user-attachments/assets/188c42f8-d249-4a72-b27a-e2b4f10a00a8" alt="SafeRelay Android Logo" width="480">
</p>

> [!WARNING]
> This software has not received external security review and may contain vulnerabilities and may not necessarily meet its stated security goals. Do not use it for sensitive use cases, and do not rely on its security until it has been reviewed. Work in progress.

# saferelay for Android

A secure, decentralized, peer-to-peer messaging app that works over Bluetooth mesh networks. No internet required for mesh chats, no servers, no phone numbers - just pure encrypted communication. SafeRelay also supports geohash channels, which use an internet connection to connect you with others in your geographic area.

This is the **Android port** of the original [saferelay iOS app](https://github.com/jackjackbits/saferelay), maintaining 100% protocol compatibility for cross-platform communication.

## Install saferelay

You can download the latest version of saferelay for Android from the [GitHub Releases page](https://github.com/permissionlesstech/saferelay-android/releases).

Or you can:

[<img alt="Get it on Google Play" height="60" src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png"/>](https://play.google.com/store/apps/details?id=com.saferelay.droid)
...
- **✅ Cross-Platform Compatible**: Full protocol compatibility with iOS saferelay
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/permissionlesstech/saferelay-android.git
...
2. **Open in Android Studio:**
   ...
   # Navigate to the saferelay-android directory
   ```
...
3. **Launch saferelay** - it will auto-start mesh networking
4. **Set your nickname** or use the auto-generated one
5. **Connect automatically** to nearby iOS and Android saferelay users
...
### Binary Protocol
saferelay uses an efficient binary protocol optimized for Bluetooth LE:
...
1. **SafeRelayApplication.kt**: Application-level initialization and dependency injection
...
This Android port enables seamless communication with the original iOS saferelay app:
...
**iOS Version**: For iPhone/iPad users, get the original saferelay at [github.com/jackjackbits/saferelay](https://github.com/jackjackbits/saferelay)
...
- **iOS Compatibility**: Cross-reference with [original iOS repo](https://github.com/jackjackbits/saferelay)

For iOS-specific issues, please refer to the [original iOS saferelay repository](https://github.com/jackjackbits/saferelay).
# SafeRelay-Android
